 ...
 * Modified by Waris Agung Widodo (ido.alit@gmail.com) @2021-06-07 14:58
 *
...
class BiblioList extends \biblio_list_model
{
     ...
     * @return  void
     */
    public function setSQLcriteria($str_criteria = null)
    {
        if (!$str_criteria)
            return null;
        // defaults
    ...
    public function compileSQL()
    {
        ...
        // init sql string
        $_sql_str = 'SELECT biblio.biblio_id, biblio.title, biblio.image, biblio.isbn_issn,
        ...
        $_add_sql_str = ' LEFT JOIN biblio_custom AS bc ON biblio.biblio_id=bc.biblio_id ';
    ...
    public function compileSQLCount() {
        ...
        $_sql_str .= ' FROM biblio ' . $_add_sql_str;
        return $_sql_str;
    }
}
